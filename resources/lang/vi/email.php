...
return [
    ...
    'admin'            => [
        ...
        'smtp_user'      => 'User SMTP',
        'smtp_host'      => 'Server SMTP',
        'help_note'      => '<span class="text-red">(*)</span>: Email sẽ không được gửi trực tiếp, mà thông qua hàng đợi. Bạn cần phải cài đặt "artisan schedule:run" trước,  chi tiết <a href="https://black-cart.org/docs/'.config('black-cart.version').'/email.html">TẠI ĐÂY</a>',
    ],
