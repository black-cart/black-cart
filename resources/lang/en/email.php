...
return [
    ...
    'admin'            => [
        ...
        'help_note'      => '<span class="text-red">(*)</span>: Emails will not be sent directly, but through a queue. You need to set up "artisan schedule: run" first, details <a href="https://black-cart.org/docs/'.config('black-cart.version').'/email.html">HERE</a>',
