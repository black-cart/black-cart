...
@php
$productsNew = $modelProduct->start()->getProductLatest()->setlimit(bc_config('product_top', $storeId))->setStore($storeId)->getData();
@endphp
...
@section('block_main_content_center')
      ...
      <div class="col-lg-8 col-xl-9">
          ...
          <div class="row row-30 row-lg-50">
            ...
            <div class="col-sm-6 col-md-4">
                ...
                <article class="product wow fadeInRight">
                  ...
                  {{-- Product type --}}
                  @if ($productNew->price != $productNew->getFinalPrice() && $productNew->kind != BC_PRODUCT_GROUP)
                    <span><img class="product-badge new" src="{{ asset($bc_templateFile.'/images/home/sale.png') }}" class="new" alt="" /></span>
                  @elseif($productNew->kind == BC_PRODUCT_BUILD)
                    <span><img class="product-badge new" src="{{ asset($bc_templateFile.'/images/home/bundle.png') }}" class="new" alt="" /></span>
                  @elseif($productNew->kind == BC_PRODUCT_GROUP)
                    <span><img class="product-badge new" src="{{ asset($bc_templateFile.'/images/home/group.png') }}" class="new" alt="" /></span>
                  @endif
                  {{--// Product type --}}
        ...
        @if (function_exists('bc_vendor_get_categories_front') &&  count(bc_vendor_get_categories_front($storeId)))
        @foreach (bc_vendor_get_categories_front($storeId) as $category)
          ...
          <div class="container">
                ...
                <div class="row row-30 row-lg-50">
                  @php
                      ...
                      ->setLimit(bc_config('product_top', $storeId))->getData()
                  @endphp
  ...
  <div class="breadcrumbs-custom-footer">
    <div class="container">
      <ul class="breadcrumbs-custom-path">
        ...
        <li class="active">{{ bc_store('title', $storeId) }}</li>
      </ul>
    </div>
  </div>
</section>
