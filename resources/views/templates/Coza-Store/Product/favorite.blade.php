                    ...
                    <tbody>
                        ...
                        <tr class="row_cart">
                            ...
                            <td class="td-action">
                                ...
                                onClick="confirmMsg('Are you sure ?','You won\'t be able to revert this!','{{ bc_route('cart.remove', ['id'=>$item->rowId, 'instance' => 'wishlist']) }}');">
                                    <i class="tim-icons icon-simple-remove"></i>
                                </button>
                            </td>
                        </tr>
...
<div class="page-header page-header-small">
  <div class="container pl-0 pr-0">
    <nav aria-label="breadcrumb" role="navigation">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ bc_route('home') }}">{{ trans('front.home') }}</a></li>
