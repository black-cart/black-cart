...
function debounce(i, n, t) {
    ...
    0 != $tagsinput.length && $tagsinput.tagsinput(), $(".bootstrap-tagsinput").find(".tag").addClass("badge-" + a),$(".bootstrap-tagsinput").addClass('form-control'), 0 != $selectpicker.length && $selectpicker.selectpicker({
        iconBase: "tim-icons",
