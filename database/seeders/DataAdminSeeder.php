...
class DataAdminSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_menu')->insert(
            [
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_permission')->insert(
            [
            ['id' => '1', 'name' => 'Auth manager', 'slug' => 'auth.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/auth/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '2', 'name' => 'Dashboard', 'slug' => 'dashboard', 'http_uri' => 'GET::'.BC_ADMIN_PREFIX.'', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '3', 'name' => 'Base setting', 'slug' => 'base.setting', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/order_status/*,ANY::'.BC_ADMIN_PREFIX.'/shipping_status/*,ANY::'.BC_ADMIN_PREFIX.'/payment_status/*,ANY::'.BC_ADMIN_PREFIX.'/supplier/*,ANY::'.BC_ADMIN_PREFIX.'/brand/*,ANY::'.BC_ADMIN_PREFIX.'/custom_field/*,ANY::'.BC_ADMIN_PREFIX.'/weight_unit/*,ANY::'.BC_ADMIN_PREFIX.'/length_unit/*,ANY::'.BC_ADMIN_PREFIX.'/attribute_group/*,ANY::'.BC_ADMIN_PREFIX.'/tax/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '4', 'name' => 'Store manager', 'slug' => 'store.full','http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/store_info/*,ANY::'.BC_ADMIN_PREFIX.'/store_maintain/*,ANY::'.BC_ADMIN_PREFIX.'/store_config/*,ANY::'.BC_ADMIN_PREFIX.'/store_css/*,ANY::'.BC_ADMIN_PREFIX.'/store_block/*,ANY::'.BC_ADMIN_PREFIX.'/store_link/*','created_at' => date('Y-m-d H:i:s')],
            ['id' => '5', 'name' => 'Product manager', 'slug' => 'product.full','http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/product/*,ANY::'.BC_ADMIN_PREFIX.'/product_property/*,ANY::'.BC_ADMIN_PREFIX.'/product_tag/*','created_at' => date('Y-m-d H:i:s')],
            ['id' => '6', 'name' => 'Category manager', 'slug' => 'category.full','http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/category/*','created_at' => date('Y-m-d H:i:s')],
            ['id' => '7', 'name' => 'Order manager', 'slug' => 'order.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/order/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '8', 'name' => 'Upload management', 'slug' => 'upload.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/uploads/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '9', 'name' => 'Extension manager', 'slug' => 'extension.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/template/*,ANY::'.BC_ADMIN_PREFIX.'/plugin/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '10', 'name' => 'Marketing manager', 'slug' => 'marketing.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/shop_discount/*,ANY::'.BC_ADMIN_PREFIX.'/email_template/*,ANY::'.BC_ADMIN_PREFIX.'/customer/*,ANY::'.BC_ADMIN_PREFIX.'/subscribe/*,ANY::'.BC_ADMIN_PREFIX.'/seo/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '11', 'name' => 'Report manager', 'slug' => 'report.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/report/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '12', 'name' => 'CMS manager', 'slug' => 'cms.full', 'http_uri' => 'ANY::'.BC_ADMIN_PREFIX.'/page/*,ANY::'.BC_ADMIN_PREFIX.'/banner/*,ANY::'.BC_ADMIN_PREFIX.'/banner_type/*, ANY::'.BC_ADMIN_PREFIX.'/cms_category/*,ANY::'.BC_ADMIN_PREFIX.'/cms_content/*,ANY::'.BC_ADMIN_PREFIX.'/news/*', 'created_at' => date('Y-m-d H:i:s')],
            ['id' => '13', 'name' => 'Update config', 'slug' => 'change.config', 'http_uri' => 'POST::'.BC_ADMIN_PREFIX.'/store_config/update', 'created_at' => date('Y-m-d H:i:s')],
             ]
        );

        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_role')->insert(
            [
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_role_permission')->insert(
            [
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_role_user')->insert(
            ['role_id' => '1', 'user_id' => '1']
        );
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_user')->insert(
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_config')->insert(
            [
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_store')->insert(
            [
        ...
        DB::connection(BC_CONNECTION)->table(BC_DB_PREFIX.'admin_store_description')->insert(
            [
