...
INSERT INTO `sc_admin_permission` VALUES (1,'Auth manager','auth.full','ANY::sc_admin/auth/*','2021-04-03 03:04:47',NULL),(2,'Dashboard','dashboard','GET::sc_admin','2021-04-03 03:04:47',NULL),(3,'Base setting','base.setting','ANY::sc_admin/order_status/*,ANY::sc_admin/shipping_status/*,ANY::sc_admin/payment_status/*,ANY::sc_admin/supplier/*,ANY::sc_admin/brand/*,ANY::sc_admin/custom_field/*,ANY::sc_admin/weight_unit/*,ANY::sc_admin/length_unit/*,ANY::sc_admin/attribute_group/*,ANY::sc_admin/tax/*','2021-04-03 03:04:47',NULL),(4,'Store manager','store.full','ANY::sc_admin/store_info/*,ANY::sc_admin/store_maintain/*,ANY::sc_admin/store_config/*,ANY::sc_admin/store_css/*,ANY::sc_admin/store_block/*,ANY::sc_admin/store_link/*','2021-04-03 03:04:47',NULL),(5,'Product manager','product.full','ANY::sc_admin/product/*,ANY::sc_admin/product_property/*,ANY::sc_admin/product_tag/*','2021-04-03 03:04:47',NULL),(6,'Category manager','category.full','ANY::sc_admin/category/*','2021-04-03 03:04:47',NULL),(7,'Order manager','order.full','ANY::sc_admin/order/*','2021-04-03 03:04:47',NULL),(8,'Upload management','upload.full','ANY::sc_admin/uploads/*','2021-04-03 03:04:47',NULL),(9,'Extension manager','extension.full','ANY::sc_admin/template/*,ANY::sc_admin/plugin/*','2021-04-03 03:04:47',NULL),(10,'Marketing manager','marketing.full','ANY::sc_admin/shop_discount/*,ANY::sc_admin/email_template/*,ANY::sc_admin/customer/*,ANY::sc_admin/subscribe/*,ANY::sc_admin/seo/*','2021-04-03 03:04:47',NULL),(11,'Report manager','report.full','ANY::sc_admin/report/*','2021-04-03 03:04:47',NULL),(12,'CMS manager','cms.full','ANY::sc_admin/page/*,ANY::sc_admin/banner/*,ANY::sc_admin/banner_type/*, ANY::sc_admin/cms_category/*,ANY::sc_admin/cms_content/*,ANY::sc_admin/news/*','2021-04-03 03:04:47',NULL),(13,'Update config','change.config','POST::sc_admin/store_config/update','2021-04-03 03:04:47',NULL);
...
INSERT INTO `sc_admin_store` VALUES (1,'data/logo/Scart-mid.png','0123456789','Support: 0987654321','demo@black-cart.org','','123st - abc - xyz',NULL,NULL,'black-cart-light','localhost/black-cart/public','0','root','en','Asia/Ho_Chi_Minh','USD',1,1);
...
INSERT INTO `sc_admin_store_description` VALUES (1,'en','Demo black-cart : Free Laravel eCommerce','Free website shopping cart for business','','<center><img src=\"/images/maintenance.png\" />\r\n    <h3><span style=\"color:#e74c3c;\"><strong>Sorry! We are currently doing site maintenance!</strong></span></h3>\r\n    </center>','Website is in maintenance mode!'),(1,'vi','Demo black-cart: M├ú nguß╗ôn website th╞░╞íng mß║íi ─æiß╗çn tß╗¡ miß╗àn ph├¡','Laravel shopping cart for business','','<center><img src=\"/images/maintenance.png\" />\r\n    <h3><span style=\"color:#e74c3c;\"><strong>Xin lß╗ùi! Hiß╗çn tß║íi website ─æang bß║úo tr├¼!</strong></span></h3>\r\n    </center>','Website ─æang trong chß║┐ ─æß╗Ö bß║úo tr├¼!');
...
INSERT INTO `sc_admin_user` VALUES (1,'admin','$2y$10$nUKG4CDdXL7h2JibT2KVqeRqNoog4162LW6xcZl73.VWo0zf6qMLO','Administrator','demo@black-cart.org','/admin/avatar/user.jpg',NULL,NULL,'2021-04-03 03:04:47',NULL);
...
INSERT INTO `sc_api_connection` VALUES (1,'Demo api connection','appmobile','6067db4feae0d',NULL,NULL,0);
...
INSERT INTO `sc_shop_category_description` VALUES (1,'en','Electronics','',''),(1,'vi','Thiß║┐t bß╗ï ─æiß╗çn tß╗¡','',''),(2,'en','Clothing & Wears','',''),(2,'vi','Quß║ºn ├ío','',''),(3,'en','Mobile','',''),(3,'vi','─Éiß╗çn thoß║íi','',''),(4,'en','Accessaries & Extras','',''),(4,'vi','Phß╗Ñ kiß╗çn ','',''),(5,'en','Computers','',''),(5,'vi','M├íy t├¡nh','',''),(6,'en','Tablets','',''),(6,'vi','M├íy t├¡nh bß║úng','',''),(7,'en','Appliances','',''),(7,'vi','Thiß║┐t bß╗ï','',''),(8,'en','Men\'s Clothing','',''),(8,'vi','Quß║ºn ├ío nam','',''),(9,'en','Women\'s Clothing','',''),(9,'vi','Quß║ºn ├ío nß╗»','',''),(10,'en','Kid\'s Wear','',''),(10,'vi','─Éß╗ô trß║╗ em','',''),(11,'en','Mobile Accessaries','',''),(11,'vi','Phß╗Ñ kiß╗çn ─æiß╗çn thoß║íi','',''),(12,'en','Women\'s Accessaries','',''),(12,'vi','Phß╗Ñ kiß╗çn nß╗»','',''),(13,'en','Men\'s Accessaries','',''),(13,'vi','Phß╗Ñ kiß╗çn nam','','');
...
INSERT INTO `sc_shop_customer` VALUES (1,'Naruto','Kun',NULL,NULL,'test@test.com',NULL,NULL,'$2y$10$6M5lQmYIm0pOW9bBbhYUVeljlUpdgcRdt6C7fw8.EHgOemTQgeuu2',0,'70000','HCM','HCM city',NULL,'KTC','VN','0667151172',1,NULL,1,1,NULL,'2021-04-03 03:04:47',NULL,NULL,NULL);
...
INSERT INTO `sc_shop_customer_address` VALUES (1,1,'Naruto','Kun',NULL,NULL,'70000','HCM','HCM city',NULL,'VN','0667151172');
